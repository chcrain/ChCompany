...
// This route receives a prompt and sends it to YOUR CUSTOM FALCON MODEL on Hugging Face.
app.post("/api/chat", async (req, res) => {
  ...
  try {
    // Update this URL to your actual Falcon model if different
    // e.g. "chcrain/falcon-7b-instruct-finetuned"
    const hfUrl = "https://api-inference.huggingface.co/models/chcrain/falcon-7b-instruct-finetuned";
